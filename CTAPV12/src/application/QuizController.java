...
public class QuizController {
    ...
    @FXML
    public Label questionNumberlbl, questionsRemaining, questionPrompt, name, testIdLbl, topicNameLbl, userIdLbl;
    ...
    public void loadTopicQuestions() {
        ...
        if (counter >= 0 && counter < QUESTION_IDS.length) {
            ...
            optionA.setImage(imageOption1);
            optionB.setImage(imageOption2);
            optionC.setImage(imageOption3);
            optionD.setImage(imageOption4);
